...
# this is an OLD version of the parser, but it should still work........ maybe
    ...
    "alignments": {
        "center": {
            "SEJA_DECLARATION": {
                ...
                "test": lambda chunk: chunk.bold,  # bold baby
                "action": pop_and_push_to("div", tag="head", type="session"),
            },
            "TIME": {
                "alignment": WD_PARAGRAPH_ALIGNMENT.CENTER,
                "test": lambda run: run.italic
            ...
            "CHAIRMAN": {
                "alignment": WD_PARAGRAPH_ALIGNMENT.CENTER,
                "test": lambda chunk: tag_is_on_top("time")
                or tag_is_on_top(
                    "note", type="chairman"
